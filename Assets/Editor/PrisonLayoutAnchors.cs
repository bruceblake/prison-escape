...
/// <summary>
/// World-space anchors for the expanded PrisonLevel1 layout.
...
public static class PrisonLayoutAnchors
{
    ...
    public static Vector3 KitchenCenter(Vector3 servingCounterFallback)
    {
        var serving = GameObject.Find("ServingCounter");
        return serving != null
            ? serving.transform.position + new Vector3(0f, -0.7f, -12f)
            : servingCounterFallback;
    }
}
