...
public static class PrisonLootSetupRunner
{
    ...
    public static void PlaceWorldSpawnNodesFromLayout()
    {
        ...
        Vector3 kitchen = PrisonLayoutAnchors.KitchenCenter(new Vector3(-16f, 0.6f, -83f));
        ...
        PlaceSpawnNode(kitchenRoot, "K01", kitchen + new Vector3(-3f, 0f, 2f), kitchenTable ?? common, 0.65f);
        PlaceSpawnNode(kitchenRoot, "K02", kitchen + new Vector3(3f, 0f, -2f), kitchenTable ?? common, 0.60f);
        PlaceSpawnNode(kitchenRoot, "K03", kitchen + new Vector3(-5f, 0f, -3f), kitchenTable ?? common, 0.55f);
        ...
        if (rare != null)
        {
            ...
            PlaceSpawnNode(hiddenRoot, "H04", kitchen + new Vector3(5f, 0f, 4f), rare, 0.45f);
    ...
    private static void SetupYardZone(Vector3 groundCenter)
    {
        var existing = GameObject.Find("YardZone");
        var zoneGo = existing != null ? existing : new GameObject("YardZone");
        zoneGo.transform.position = groundCenter + new Vector3(0f, 0.5f, 0f);
